...
> **Durum:** Faz 5 sürüyor — **ilk üç modül bitti** (CRM · Projeler · Finans), sıradaki 4. modül Randevu/Rezervasyon
> **Sürüm:** 2.2
...
> ⚠️ **Retention borcu [§8.5](#85-retention-borcu-oniki-tablo-tek-karar)'te Slice 5 ile ONİKİYE ÇIKTI** (`finance.commentaries` + `finance.commentary_chunks`) ve vektör taşıyan tablo sayısı **dörde** çıktı. Cümle Slice 7'de gelecek zamandan geçmiş zamana alındı; tablolar Slice 5'te gerçekten açıldı ve liste o gün değil **modül kapanırken** güncellendi.
>
...
| **Tablo retention politikası** — ayrıntı ve tam liste [§8.5](#85-retention-borcu-oniki-tablo-tek-karar)'te | ❌ Yok — **büyüyen borç**, artık **oniki tablo**                                                      | Faz 4                                        |
...
Gerçek müşteri ve ödeme verisi Faz 6'da girer. Veri saklama süreleri, silme hakkı ve işleme envanteri **veri girmeden önce** tasarlanırsa bir tasarım kararıdır; sonra tasarlanırsa bir göç projesidir. Faz 3'te açılıp Faz 4'te büyüyen retention borcu ([§8.5](#85-retention-borcu-oniki-tablo-tek-karar)) bu kontrol noktasının ilk girdisidir.
