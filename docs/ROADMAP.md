...
> **Durum:** Faz 5 sürüyor — 1. modül (CRM) ve 2. modül (Projeler) bitti, 3. modül (Finans) sürüyor ([ADR-0034](adr/0034-finance-module.md))
> **Sürüm:** 2.1
...
Faz 5 **on iki iş modülü** kapsar. Sıra ve kapsam [§3.5](#35-modül-sıralaması--on-iki-modül-product-owner-kararı)'te. **1. modül (CRM) ve 2. modül (Projeler) bitti**, ikisi de prod'da ([§3.6](#36-2-modül-projeler--yeni-olan-tek-şey-cross-modül-referans)); **3. modül (Finans) sürüyor** ([§3.7](#37-3-modül-finans--desen-üçüncü-kez-ama-üç-yeni-soruyla)).
...
| **3**  | **Finans**                         | Gelir · gider · nakit akışı — "finansal hafıza" ([ADR-0034](adr/0034-finance-module.md))                  | 🟡 Sürüyor  |
...
> ⚠️ **Retention borcu [§8.5](#85-retention-borcu-on-tablo-tek-karar)'te Slice 5 ile ONİKİYE çıkacak** (`finance.commentaries` + `finance.commentary_chunks`) ve vektör taşıyan tablo sayısı **dörde** çıkacak. Liste bugün güncellenmedi çünkü tablolar henüz yok — ADR-0034 bunu bilinen sonuç olarak kaydetti.
>
